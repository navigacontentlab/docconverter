...
func (pi *PlanningItem) DocToPlanningItem(document *doc.Document, opts *Options) error {
...
func (pi *PlanningItem) PlanningItemToDoc(planningItem *PlanningItem, opts *Options) (*doc.Document, error) {
