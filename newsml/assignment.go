...
func (a *Assignment) DocToAssignment(document *doc.Document, opts *Options) error {
...
func (a *Assignment) AssignmentToDoc(assignment *Assignment, opts *Options) (*doc.Document, error) {
